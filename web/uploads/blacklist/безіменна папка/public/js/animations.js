    ...
    switchChoose(item){
        if(this.check.getAttribute('selected') == 1){
            ...
            if(item.value == 1){
                ...
                setTimeout(() => {
                    this.title.innerHTML = this.title.getAttribute('data-text-1');
                    this.title.classList.remove('animate');
                }, 700);
            } else if(item.value == 2){
                this.title.classList.add('animate');
                setTimeout(() => {
                    this.title.innerHTML = this.title.getAttribute('data-text-2');
                    this.title.classList.remove('animate');
                }, 700);
            }
            ...
            if(item.value == 1){
                this.title.classList.add('animate');
                setTimeout(() => {
                    this.title.innerHTML = this.title.getAttribute('data-text-3');
                    this.title.classList.remove('animate');
                }, 700);
            } else{
                this.title.classList.add('animate');
                setTimeout(() => {
                    this.title.innerHTML = this.title.getAttribute('data-text-4');
                    this.title.classList.remove('animate');
                }, 700);
            }
        }
